...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Check if the "recordStatus" key exists in the $_POST array
    ...
    if ($recordStatus == "New" || $recordStatus == "Amend") {
        ...
        if ($result) {
            if ($result->num_rows > 0) {
                ...
                echo "No records found for the given Regulation Number: $regulationNumber";
                // You can redirect or take other actions as needed.
            }
        } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submitUpdate"])) {
    ...
    $sql = "UPDATE srsmPersonnel 
            SET name='$updatedName', forenameTwo='$updatedForenameTwo', surname='$updatedSurname',
                rankname='$updatedRankname', emailAddress='$updatedEmailAddress', gender='$updatedGender'
